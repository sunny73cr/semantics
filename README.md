...
Also consider the implementation of 'printf' within GNU coreutils: ['printf.c'](https://git.savannah.gnu.org/), or GNU glibc: ['printf.c > __vfprintf_internal.c | glibc-2.42.9000'](https://git.savannah.gnu.org/) ... if you can find them. I have some trouble doing so, myself.
